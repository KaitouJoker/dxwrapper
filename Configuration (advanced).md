...
공식 영문 설정 가이드는 [DxWrapper Configuration Wiki](https://github.com/elishacloud/dxwrapper/wiki/Configuration-(advanced))를 참조하십시오. 본 문서는 각 파라미터의 핵심 동작 원리, 데이터 타입, 기본값, 그리고 카트라이더(Direct3D 9 x86) 최적화 권장 설정값을 일목요연하게 정리하였습니다.
